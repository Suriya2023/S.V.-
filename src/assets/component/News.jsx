...
function News() {
  ...
  <div className="w-2/4 max-lg:w-full">
    <h1 className="text-center text-2xl  font-bold mb-8 text-black">Latest News</h1>
    <div className="w-11/12 border rad custom-div-height custom-div-design p-8 overflow-hidden">
    ...
    <br />
    <div class="w-11/12 border custom-div-height custom-div-design custom-mt p-8 overflow-hidden">
      <h1 className='highlightt'>22-12-2024</h1>
      <p>May 2024 - Newsletter</p>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore facere debitis nobis, adipisci eos, tenetur deserunt mollitia ea qui eaque iusto! Distinctio veniam iusto repellendus? Labore delectus tempora blanditiis natus?</p>
      <br />
  ...
  <div class="w-2/4  max-lg:w-full max-lg:mt-16">
    <h1 class="text-center text-2xl   font-bold mb-8 text-black ">Notices &amp; Circulars</h1>
    <div class="w-11/12 border h-40 custom-div-design p-8 overflow-hidden">
    ...
    <br />
    <div class="w-11/12 border h-40 custom-div-design p-8 overflow-hidden custom-mt">
      <div class="flex justify-evenly">
        <div  className='myimgbs'>
